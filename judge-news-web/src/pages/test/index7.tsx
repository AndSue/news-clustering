import { classify, getKeywords, selectNews, spider } from '@/services/servies';
import { PageContainer } from '@ant-design/pro-components';
import { Button, Form, Input, InputNumber, Popconfirm, Radio, Space, Table, message, Drawer, DatePicker, DatePickerProps, Modal, Spin, Steps, Card, Collapse, CollapseProps, Row, Col, Empty, Result } from 'antd';
    ...
    */
    {
      ...
      content: <>
        ...
        <Result
          status="success"
          title="分类成功！"
          subTitle="请点击下面的按钮跳转至分类记录界面查看结果~"
          extra={[
